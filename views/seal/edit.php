...
<article class="main-content label">
    ...
    <div class="tabs-content">
      ...
      <?php if($this->isEditable()) {?>
            ...
            [substituir]: <?php \MapasCulturais\i::_e("Valor do campo escolhido pelo candidato");?><br>
            </p>
  				<span class="descricao js-editable" data-edit="certificateText"
                   data-original-title="<?php \MapasCulturais\i::esc_attr_e("Conteúdo da Impressão do Certificado");?>" 
                   data-emptytext="<?php \MapasCulturais\i::esc_attr_e("Insira o conteúdo da impressão do certificado do selo.");?>" ><?php echo nl2br($entity->certificateText); ?></span>
